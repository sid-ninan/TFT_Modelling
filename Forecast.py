...
# --- 6. PARSE THE QUANTILE CHANNELS ---
# The prediction object holds all 3 requested quantiles (0.1, 0.5, 0.9)
# We isolate the 90th percentile to build our safety grid buffer
p90_power_forecast = prediction["facility_power_kw_0.9"]

# Extract the maximum predicted power value within our 15-minute look-ahead window
max_predicted_p90_kw = p90_power_forecast.max().values()[0][0]
current_grid_capacity_kw = 600.0 # Hypothetical constraint threshold of your current setup

# --- 7. AUTOMATION ACTION LOOP ---
